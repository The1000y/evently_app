                              ...
                              TextFormField(
                                ...
                                validator: (value) {
                                  if (value == null || value.trim().isEmpty) {
                                    return local.enter_name_error;
                                  }
                                  bool valiedName = RegExp(
                                    '[a-zA-Z]',
                                  ).hasMatch(value);
                                  if (!valiedName) {
                                    return local.name_short_error;
                                  }
                                  return null;
                                },
                                ...
                                builder: (context, value, child) {
                                  return TextFormField(
                                    ...
                                    validator: (value) {
                                      ...
                                      if (value.length < 6) {
                                        return local.password_short_error;
                                      }
                                      ...
                                      if (!validPasswod) {
                                        return local.wrong_password_error;
                                      }
                                      return null;
                                    },
                                    obscureText: value,
                                  ...
                                  return TextFormField(
                                    validator: (value) {
                                      ...
                                      if (value != passwordController.text) {
                                        return local.password_not_match_error;
                                      }
                                      if (value.length < 6) {
                                        return local.password_not_match_error;
                                      }
                                    ...
                                    decoration: InputDecoration(
                                      hintText: local.confirm_password_error,
                                      hintStyle: TextStyle(
                                        color: appProvider.isDark
                                            ? AppColor.darkModeMainTextColor
                                            : AppColor.lightModeSecTextColor,
